...
HD_PWD='C:/Users/carlo/OneDrive - University of Idaho/UofI_19-20/Spring_2020/ECE_440/lab_4/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_cir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory_cir.tcl
