...
HD_PWD='C:/Users/carlo/Downloads/lab_4/project_4_2/project_4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_cir_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mem_cir_wrapper.tcl -notrace
