...
HD_PWD='C:/Users/carlo/Downloads/lab_4/project_4_2/project_4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_cir_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_cir_wrapper.tcl
