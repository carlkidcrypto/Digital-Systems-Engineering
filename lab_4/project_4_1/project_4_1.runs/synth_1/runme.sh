...
HD_PWD='C:/Users/carlo/Downloads/lab_4/project_4_1/project_4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circuit_top.tcl
