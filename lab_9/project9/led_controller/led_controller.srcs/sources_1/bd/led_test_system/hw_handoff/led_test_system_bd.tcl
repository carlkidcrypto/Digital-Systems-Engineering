...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins led_controller_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
preplace portBus LEDs_out -pg 1 -y 130 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 90 -defaultsOSRD
preplace inst led_controller_0 -pg 1 -lvl 3 -y 130 -defaultsOSRD
...
preplace netloc led_controller_0_LEDs_out 1 3 1 NJ
...
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 410 230 690J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 180 420 300 680
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N
levelinfo -pg 1 0 210 550 810 950 -top 0 -bot 370
",
}
