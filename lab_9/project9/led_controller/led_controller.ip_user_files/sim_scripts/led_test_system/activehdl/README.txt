...
#
# Generated by export_simulation on Mon Apr 06 11:45:44 -0700 2020
#
################################################################################
...
switch to the './led_test_system.sh' script.

./led_test_system.sh -reset_run
...
./led_test_system.sh -noclean_files

For more information on the script, please type './led_test_system.sh -help'.
