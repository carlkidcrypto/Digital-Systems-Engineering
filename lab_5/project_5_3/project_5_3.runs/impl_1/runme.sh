...
HD_PWD='C:/Users/carlo/Downloads/project_5_3/project_5_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BMEM_GCD_SPI_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BMEM_GCD_SPI_Wrapper.tcl -notrace
