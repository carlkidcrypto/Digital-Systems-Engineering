...
HD_PWD='C:/Users/carlo/Downloads/project_5_2/project_5_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BMEM_GCD_SPI_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BMEM_GCD_SPI_Wrapper.tcl
