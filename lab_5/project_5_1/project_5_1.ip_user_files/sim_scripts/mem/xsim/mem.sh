...
#
# Generated by Vivado on Tue Feb 25 21:04:03 -0800 2020
...
# Script info
echo -e "mem.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem xil_defaultlib.mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim mem -key {Behavioral:sim_1:Functional:mem} -tclbatch cmd.tcl -log simulate.log
}
