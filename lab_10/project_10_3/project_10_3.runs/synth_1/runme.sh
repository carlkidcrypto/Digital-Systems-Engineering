...
HD_PWD='C:/Users/carlo/Downloads/project_10_3/project_10_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fact_co_processor_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fact_co_processor_wrapper.tcl
