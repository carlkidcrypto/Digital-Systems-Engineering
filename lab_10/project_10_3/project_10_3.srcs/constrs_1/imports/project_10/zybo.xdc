...
##Clock signal
##IO_L11P_T1_SRCC_35	
set_property PACKAGE_PIN L16 [get_ports src_clk]
set_property IOSTANDARD LVCMOS33 [get_ports src_clk]
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports src_clk]
